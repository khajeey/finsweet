  ...
  return (
    <>
      <section className="w-[1250px] mx-auto flex flex-col items-center justify-center mt-[50px] gap-[20px]">
        ...
        <p>{position}</p>
        <p className="w-[500px] text-center text-[18px] font-light">
          Lorem ipsum dolor sit amet consectetur adipisicing elit. Eum odit
          placeat, dolor fugit adipisci quos. Ullam quam possimus autem animi.
        </p>
      </section>
          ...
          <div className="flex justify-between mt-[100px]">
            <div className="flex bg-white justify-between">
              ...
              <div className="p-[20px]">
                ...
                <a className="text-blue-700 items-center flex gap-4" href="#">
