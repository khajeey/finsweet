  ...
  return (
    <>
      <section className="w-[1250px] mx-auto mt-[50px]">
        ...
        <h1 className="bg-[url('/imgs/comp-1.png')] bg-cover bg-bottom-left text-transparent bg-clip-text text-[200px] text-center font-bold">
          Careers
        </h1>
        ...
        <div className="w-[600px] my-[50px]">
          <h3 className="tracking-[0.21em]">OUR WORK & CULTURE</h3>
